import { Box, Button, Flex, FormControl, FormLabel, GlobalStyle, Image, Input, LightMode, Select, Text } from '@chakra-ui/react'
        ...
        <LightMode>
          ...
          <Flex h="100vh" overflowY="scroll" justifyContent="center" alignItems="center">
            ...
            <Box
              ...
              borderRadius={24}
              bg="white"
              px={{ base: 7, md: 10, xl: 12 }}
              py={7}
              textAlign="center"
              maxH={{ base: '100dvh', md: 480, '1xl': 540 }}
              overflowY="scroll"
            >
              <Box maxW={{ base: 480, '1xl': 570 }} mx="auto">
