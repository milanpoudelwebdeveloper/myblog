  ...
  return (
    <MainLayout>
      <Box>
        ...
        <Text lineHeight="1.6">
          Welcome to this blog site. I am Milan Poudel from Nepal and I am the maintainer, creator and author of this platform. I have built
          this platform from scratch using different technologies and with a lot of passion.. With this platform, I want to share my
          knowledge and experience that I have gained through years. I believe that knowledge is the power and sharing knowledge is the best
        ...
        <Text mt={7} mb={8} lineHeight="1.64">
          ...
          for you and will send an activation email. If you want to contribute in any other way, you can contact me. I will be happy to work
          with you. If there&apos;s something that you want to learn, please let me know. I will try to write a blog on that topic if that
